...
class RepositorioDeAlunoComPdo implements RepositorioDeAluno
{
    ...
    public function buscarTodos(): array
    {
        ...
        foreach ($listaDadosAlunos as $dadosAluno) {
            if (!array_key_exists($dadosAluno['cpf'], $listaDadosAlunos)) {
            ...
            $listaDadosAlunos[$dadosAluno['cpf']]->adicionarTelefone($dadosAluno['ddd'], $dadosAluno['numero_telefone']);
        }

        return  array_values($listaDadosAlunos);
    }
